...
public class GetNotesAsynTask extends AsyncTask<String, String, Void>{
	...
	public GetNotesAsynTask(final Context context) {
		this.context = context;
		sql = "select * from notes where course = 'M.C.A.';";
	...
	protected void onPostExecute(Void v) {
		...
		try{
			if("false".equals(result))
				...
				Intent intent = new Intent("com.ntes.student.mba.NotesActivity");
