...
public class AllTestsAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView txtStartDate = (TextView) rowView.findViewById(R.id.txtStartDate);
			if(null != tests.get(position).getStartdate()){
				String date = tests.get(position).getStartdate().toGMTString();
				StringBuilder builder = new StringBuilder(date);
				builder.setLength(11);
				txtStartDate.setText(builder.toString());
			}
		return rowView;
	}
