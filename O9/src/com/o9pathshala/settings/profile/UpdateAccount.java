	...
	private void updatePassword() {
		...
		alert.setPositiveButton("Update", new OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				}else if (!validation.validatePassword(editTextNewPassword.getText().toString())){
					Toast.makeText(context.getApplicationContext().getApplicationContext(),"Invalid Password", Toast.LENGTH_LONG).show();
				}
