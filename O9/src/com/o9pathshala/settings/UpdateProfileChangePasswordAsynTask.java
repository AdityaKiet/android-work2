...
public class UpdateProfileChangePasswordAsynTask extends AsyncTask<String, String, Void> implements SqlConstants{
	...
	public UpdateProfileChangePasswordAsynTask(final Context context) {
		...
		TimerTask task = new TimerTask() {
			...
			public void run() {
				...
				((Activity)context).runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						if(context!= null && UpdateProfileChangePasswordAsynTask.this.isCancelled())
	...
	public UpdateProfileChangePasswordAsynTask(final Context context, InstituteDTO instituteDTO) {
		this.context = context;
	...
	protected void onPreExecute() {
		...
		progressDialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(DialogInterface arg0) {
				UpdateProfileChangePasswordAsynTask.this.cancel(true);
			}
		});
		super.onPreExecute();
	}
	...
	protected Void doInBackground(String... params) {
		...
		list.add(new BasicNameValuePair("institue_id", String.valueOf(instituteDTO.getId())));
		try {
