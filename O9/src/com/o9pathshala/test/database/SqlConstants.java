...
public interface SqlConstants {
	...
	String GET_PROFILE_PIC = "http://www.o9paathshala.com/static/users/INSTITUTE_ID/images/savedfiles/USER_ID.png";
	String MY_RANK = "select student_id,student_name,score,attempt from o9_INSTITUTE_ID_results_view where test_id='TEST_ID' order by attempt asc, score desc,attempt_date asc" ;
